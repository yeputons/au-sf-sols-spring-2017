...
Proof.
  ...
  - apply ReflectT. apply beq_id_true_iff. assumption.
  - apply ReflectF. apply beq_id_false_iff. assumption.
Qed.
(** [] *)
...
Proof.
  ...
  intros y.
  unfold t_update.
  destruct (beq_idP x1 y); destruct (beq_idP x2 y).
  - exfalso.
    assert (x1 = x2). apply eq_trans with y. assumption. symmetry. assumption.
    symmetry in H0.
    apply H in H0.
    assumption.
  - reflexivity.
